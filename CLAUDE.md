...
**In:** greedy meshing, 16x256x16 chunks, frustum culling, multithreaded chunk gen w/ Perlin noise, basic Phong lighting, block place/break, ImGui debug HUD with perf metrics.
...
(measured 2,226), "144 FPS" (measured 175), and "8x cull" (real: ~3x frustum /
12x section / up to 70x occlusion). Keep numbers to what `--bench` and
`docs/bench/` actually produce.
